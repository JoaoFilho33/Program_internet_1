...
class MicroblogPersist {
    ...
    create(post) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dB.run("INSERT INTO post (id, text, likes, title, date) VALUES (?, ?, ?, ?, ?)", post.id, post.text, post.likes, post.title, post.date);
        });
    }
    retrieve(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    update(post) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.dB.run("UPDATE post SET text = ?, likes = ?, title = ?  WHERE id = ?", post.text, post.likes, post.title, post.id);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
